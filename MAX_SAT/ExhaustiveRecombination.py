"""
Searches for all possible offspring that could result from the recombination of two parents, and returns the set of offsprings with the optimal (greatest) objective value.
Used for testing.
"""
